...
async function restoreEmployeeDataNewCluster() {
  try {
    console.log('🔄 Connecting to new MongoDB cluster (hxcedpm)...');
    ...
    // All employee data including Eden and the login page employees
    const employees = [
      // Eden admin user
      {
        employee_id: 'Eden',
    ...
    console.log('📝 Inserting/updating employee records in new cluster...');
    ...
    // Verify the data
    console.log('\n📊 Verifying employee data in new cluster...');
    ...
    console.log('\n📋 Current employees in new cluster database:');
    ...
    const adminUsers = allEmployees.filter(emp => emp.role === 'ADMIN');
    console.log('\n👑 Admin users:');
    ...
    console.log('\n✅ Employee data restoration to new cluster completed successfully!');
